...
```
/specify Quero construir um chat web com IA generativa. Nesta primeira versão,
...
```
/plan O projeto será um monorepo. Frontend: React + Vite, TypeScript, Shadcn UI
e TailwindCSS. Backend: Python com FastAPI, LangChain e LangGraph. LLM: OpenAI.
